...
int dwmonitor(float  *X, double  *D) {
    ...
    int w1;
    {
        ...
        for(int i5 = 0; i5 <= 2; i5++) {
            ...
            u3 = _mm_add_pd(_mm_max_pd(_mm_shuffle_pd(x4, x4, _MM_SHUFFLE2(0, 1)),x3), _mm_set1_pd(DBL_MIN));
            u5 = _mm_add_pd(u5, u3);
            ...
            u1 = _mm_add_pd(_mm_max_pd(_mm_shuffle_pd(x10, x10, _MM_SHUFFLE2(0, 1)),x9), _mm_set1_pd(DBL_MIN));
        }
        u6 = _mm_set1_pd(0.0);
